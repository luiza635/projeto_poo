...
@section('content')
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Editar Imagem</h2>
        ...
        <form method="POST" action="{{ route('gallery.update', $image) }}" enctype="multipart/form-data"
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4" maxlength="500"
                          class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-900">{{ old('description', $image->description) }}</textarea>
            </div>
